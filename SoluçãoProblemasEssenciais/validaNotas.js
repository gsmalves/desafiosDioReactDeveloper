...
// um programa que calcule e imprima a média semestral. Faça com que o algoritmo só aceite notas válidas 
...
const arraySoma = arr => arr.reduce((acc, current) => acc + current)

const arrayMedia = arr => arraySoma(arr) / arr.length
